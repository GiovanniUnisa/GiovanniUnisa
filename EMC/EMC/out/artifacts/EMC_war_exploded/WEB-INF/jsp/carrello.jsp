...
<jsp:include page="header.jsp">
	...
	<section>
		...
		<c:forEach items="${carrello.prodotti}" var="pq">
			<div col="1/3">
				<a href="#"><img src="img/Materiali/${pq.prodotto.id}.png"></a>
			</div>
			<div col="2/3">
				<h3>
				...
				<h5>Quantità: ${pq.quantita}, Prezzo unit. ${pq.prodotto.prezzoEuro} &euro;, Prezzo tot.(con iva) ${pq.prezzoTotEuro} &euro;</h5>
				<form action="Carrello" method="post">
					<input type="hidden" name="prodId" value="${pq.prodotto.id}">
					<input type="hidden" name="setNum" value="${pq.quantita}">
